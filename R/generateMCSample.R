#' @title generateMCSample
#' @author  James Keirstead f
#' @url http://www.r-bloggers.com/sampling-for-monte-carlo-simulations-with-r/
...
generateMCSample <- function(n, vals) {
  ...
  sob <- data.frame(sobol(n, length(vals)))
